...
public class Comments1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        postsRef1 = FirebaseDatabase.getInstance().getReference().child("Posts2").child(Post_Key3).child("Comments2");
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists()) {
                            ...
                            if (TextUtils.isEmpty(comments)) {
                                Toast.makeText(Comments1Activity.this, "Boş Yorum Gönderemezsin...", Toast.LENGTH_SHORT).show();
                            } else {
                                ...
                                postsRef1.child(postRandom1).updateChildren(commentsMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()) {
                                            Toast.makeText(Comments1Activity.this, "Başarılı bir şekilde yüklendi", Toast.LENGTH_SHORT).show();
                                        } else {
                                            Toast.makeText(Comments1Activity.this, "Eror", Toast.LENGTH_SHORT).show();
    ...
    protected void onStart() {
        ...
        super.onStart();
        FirebaseRecyclerAdapter<Comments1,Comments1ViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Comments1, Comments1ViewHolder>
                (Comments1.class,
                        R.layout.all_comments1_layout,
                        Comments1ViewHolder.class,
                        postsRef1

                )
        {
            @Override
            protected void populateViewHolder(Comments1ViewHolder viewHolder, Comments1 model, int position) {
    ...
    public static class Comments1ViewHolder extends RecyclerView.ViewHolder{
        View mView;

        public Comments1ViewHolder(@NonNull View itemView) {
            super(itemView);
            mView=itemView;
        }
        //setler yazılacak
