...
public class ClickPostSosyalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_click_post_sosyal);
        ...
        ClickPostRef2=FirebaseDatabase.getInstance().getReference().child("Sosyal").child(PostKey4);
    ...
    private void EditCurrentPost2(String description3) {
        AlertDialog.Builder builder=new AlertDialog.Builder(ClickPostSosyalActivity.this);
        builder.setTitle("DÜZENLE");
        final EditText InputField=new EditText(ClickPostSosyalActivity.this);
        ...
        builder.setPositiveButton("Güncelle", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(ClickPostSosyalActivity.this,"Post başarıyla güncellendi",Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void SendUserToMainActivity2() {
        Intent mainIntent = new Intent(ClickPostSosyalActivity.this,SosyalActivity.class);
