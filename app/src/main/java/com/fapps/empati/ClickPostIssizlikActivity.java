...
public class ClickPostIssizlikActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_click_post_issizlik);
        ...
        ClickPostRef1=FirebaseDatabase.getInstance().getReference().child("Issizlik").child(PostKey3);
    ...
    private void EditCurrentPost1(String description2) {
        AlertDialog.Builder builder=new AlertDialog.Builder(ClickPostIssizlikActivity.this);
        builder.setTitle("DÜZENLE");
        final EditText InputField=new EditText(ClickPostIssizlikActivity.this);
        ...
        builder.setPositiveButton("Güncelle", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(ClickPostIssizlikActivity.this,"Post başarıyla güncellendi",Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void SendUserToMain2Activity() {
        Intent mainIntent2 = new Intent(ClickPostIssizlikActivity.this,IssizlikActivity.class);
