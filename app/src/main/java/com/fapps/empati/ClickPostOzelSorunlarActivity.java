...
public class ClickPostOzelSorunlarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_click_post_ozel_sorunlar);
        ...
        ClickPostRef1=FirebaseDatabase.getInstance().getReference().child("OzelSorunlar").child(PostKey3);
    ...
    private void EditCurrentPost1(String description2) {
        AlertDialog.Builder builder=new AlertDialog.Builder(ClickPostOzelSorunlarActivity.this);
        builder.setTitle("DÜZENLE");
        final EditText InputField=new EditText(ClickPostOzelSorunlarActivity.this);
        ...
        builder.setPositiveButton("Güncelle", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(ClickPostOzelSorunlarActivity.this,"Post başarıyla güncellendi",Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void SendUserToMain2Activity() {
        Intent mainIntent2 = new Intent(ClickPostOzelSorunlarActivity.this,OzelSorunlarActivity.class);
