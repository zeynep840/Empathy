...
public class Comments2Activity extends AppCompatActivity {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists()) {
                            ...
                            if (TextUtils.isEmpty(comments)) {
                                Toast.makeText(Comments2Activity.this, "Boş Yorum Gönderemezsin...", Toast.LENGTH_SHORT).show();
                            } else {
                                ...
                                postsRef2.child(postRandom2).updateChildren(commentsMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()) {
                                            Toast.makeText(Comments2Activity.this, "Başarılı bir şekilde yüklendi", Toast.LENGTH_SHORT).show();
                                        } else {
                                            Toast.makeText(Comments2Activity.this, "Eror", Toast.LENGTH_SHORT).show();
    ...
    protected void onStart() {
        ...
        super.onStart();
        FirebaseRecyclerAdapter<Comments2,Comments2ViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Comments2, Comments2ViewHolder>
                (Comments2.class,
                        R.layout.all_comments2_layout,
                        Comments2ViewHolder.class,
                        postsRef2

                )
        {
            @Override
            protected void populateViewHolder(Comments2ViewHolder viewHolder, Comments2 model, int position) {
    ...
    public static class Comments2ViewHolder extends RecyclerView.ViewHolder{
        View mView;
