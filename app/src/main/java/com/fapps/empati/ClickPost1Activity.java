...
public class ClickPost1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_click_post1);
        ...
        ClickPostRef1=FirebaseDatabase.getInstance().getReference().child("Posts2").child(PostKey3);
    ...
    private void EditCurrentPost1(String description2) {
        AlertDialog.Builder builder=new AlertDialog.Builder(ClickPost1Activity.this);
        builder.setTitle("DÜZENLE");
        final EditText InputField=new EditText(ClickPost1Activity.this);
        ...
        builder.setPositiveButton("Güncelle", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(ClickPost1Activity.this,"Post başarıyla güncellendi",Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void SendUserToMain2Activity() {
        Intent mainIntent2 = new Intent(ClickPost1Activity.this,Main3Activity.class);
