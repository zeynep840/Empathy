...
public class HayvanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PostsRef4=FirebaseDatabase.getInstance().getReference().child("Hayvan");
        ...
        getSupportActionBar().setTitle("Hayvan");
        camera4=(ImageButton)findViewById(R.id.camera4);
        camera4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent4=new Intent(HayvanActivity.this,HayvanPostActivity.class);
    ...
    private void DisplayAllUserPosts4() {
        final FirebaseRecyclerAdapter<Hayvan,HayvanViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Hayvan, HayvanViewHolder>(
               Hayvan.class,
                R.layout.all_hayvan_post_layout,
               HayvanViewHolder.class,
                PostsRef4
        ) {
            @Override
            protected void populateViewHolder(HayvanViewHolder viewHolder, Hayvan model, int position) {
                ...
                viewHolder.CommentPostButton2.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent commentPostIntent1=new Intent(HayvanActivity.this,HayvanYorumActivity.class);
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent clickPostIntent=new Intent(HayvanActivity.this,ClickPostHayvanActivity.class);
    ...
    public static class HayvanViewHolder extends RecyclerView.ViewHolder {
        View mView;
