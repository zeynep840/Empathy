...
public class HayvanPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hayvan_post);
        init();
        ...
        backButton3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent geriIntent=new Intent(HayvanPostActivity.this,HayvanActivity.class);
    ...
    private void ValidePost3Info() {
        ...
        postsRef3 = FirebaseDatabase.getInstance().getReference().child("Hayvan");
                ...
                postsRef3.child(current_user_id3 + postRandom3).updateChildren(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                            startActivity(new Intent(HayvanPostActivity.this, HayvanActivity.class));
                            finish();
                        }
                        else{
                            Toast.makeText(HayvanPostActivity.this,"Eror",Toast.LENGTH_SHORT).show();
