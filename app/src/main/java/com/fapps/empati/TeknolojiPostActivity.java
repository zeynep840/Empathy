...
public class TeknolojiPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teknoloji_post);
        init();
        ...
        backButton1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent geriIntent=new Intent( TeknolojiPostActivity.this,TeknolojiActivity.class);
    ...
    private void ValidatePost1Info() {
        ...
        postsRef=FirebaseDatabase.getInstance().getReference().child("Teknoloji");
                ...
                postsRef.child(current_user_id+postRandom).updateChildren(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                            startActivity(new Intent(TeknolojiPostActivity.this,TeknolojiActivity.class));
                            finish();

                        }
                        else{
                            Toast.makeText(TeknolojiPostActivity.this,"Eror",Toast.LENGTH_SHORT).show();
