...
public class OzelSorunlarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ozel_sorunlar);
        PostsRef1=FirebaseDatabase.getInstance().getReference().child("OzelSorunlar");
        ...
        getSupportActionBar().setTitle("Özel Sorunlar");
        camera23.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent post2=new Intent(OzelSorunlarActivity.this,Posts4Activity.class);
                startActivity(post2);
                finish();
            }
        });
    ...
    private void DisplayAllUserPosts() {
        final FirebaseRecyclerAdapter<OzelSorunlar,OzelSorunlarViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<OzelSorunlar, OzelSorunlarViewHolder>
                (
                        OzelSorunlar.class,
                        R.layout.all_post_layout,
                        OzelSorunlarViewHolder.class,
                        PostsRef1
                ) {
            @Override
            protected void populateViewHolder(OzelSorunlarViewHolder viewHolder, OzelSorunlar model, int position) {
                ...
                viewHolder.CommentPostButton1.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent commentPostIntent1=new Intent(OzelSorunlarActivity.this,OzelSorunlarYorumActivity.class);
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent clickPostIntent=new Intent(OzelSorunlarActivity.this,ClickPostOzelSorunlarActivity.class);
    ...
    public static class OzelSorunlarViewHolder extends RecyclerView.ViewHolder {
        View mView;
        Button CommentPostButton1;


        public OzelSorunlarViewHolder(@NonNull View itemView) {
            super(itemView);
            mView = itemView;
