...
public class SosyalPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sosyal_post);
        init();
        ...
        usersReference3 = FirebaseDatabase.getInstance().getReference().child("Users3");
        ...
        backButton3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent geriIntent=new Intent(SosyalPostActivity.this,SosyalActivity.class);
    ...
    private void ValidePost3Info() {
        ...
        postsRef3 = FirebaseDatabase.getInstance().getReference().child("Sosyal");
                ...
                postsRef3.child(current_user_id3 + postRandom3).updateChildren(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                            startActivity(new Intent(SosyalPostActivity.this, SosyalActivity.class));
                            finish();
                        }
                        else{
                            Toast.makeText(SosyalPostActivity.this,"Eror",Toast.LENGTH_SHORT).show();
