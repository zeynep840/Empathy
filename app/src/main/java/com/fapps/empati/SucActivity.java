...
public class SucActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PostsRef4=FirebaseDatabase.getInstance().getReference().child("Suc");
    ...
    private void DisplayAllUserPosts4() {
        final FirebaseRecyclerAdapter<Suc,SucViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Suc, SucViewHolder>(
                Suc.class,
            ...
            @Override
            protected void populateViewHolder(SucViewHolder viewHolder, Suc model, int position) {
                ...
                viewHolder.CommentPostButton2.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent commentPostIntent1=new Intent(SucActivity.this,SucYorumActivity.class);
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent clickPostIntent=new Intent(SucActivity.this,ClickPostSucActivity.class);
    ...
    public static class SucViewHolder extends RecyclerView.ViewHolder {
        View mView;
        Button CommentPostButton2;


        public SucViewHolder(@NonNull View itemView) {
            super(itemView);
            mView = itemView;
