...
public class IssizlikPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_issizlik_post);
        init();
        ...
        backButton2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent geriIntent = new Intent(IssizlikPostActivity.this, IssizlikActivity.class);
                ...
                postsRef1.child(current_user_id2 + postRandom2).updateChildren(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            startActivity(new Intent(IssizlikPostActivity.this, IssizlikActivity.class));
                            finish();
                        }
                        else{
                            Toast.makeText(IssizlikPostActivity.this,"Eror",Toast.LENGTH_SHORT).show();
                        }
