...
public class GocmenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PostsRef5=FirebaseDatabase.getInstance().getReference().child("Gocmen");
        ...
        getSupportActionBar().setTitle("Göçmen");
        camera5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent post5=new Intent(GocmenActivity.this,GocmenPostActivity.class);
                startActivity(post5);
                finish();
            }
        });
    ...
    private void DisplayAllUserPosts5() {
        final FirebaseRecyclerAdapter<Gocmen,GocmenViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Gocmen, GocmenViewHolder>(
                Gocmen.class,
                R.layout.all_posts_layout,
               GocmenViewHolder.class,
                PostsRef5
        ) {
            @Override
            protected void populateViewHolder(GocmenViewHolder viewHolder, Gocmen model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent clickPostIntent=new Intent(GocmenActivity.this,ClickPostGocmenActivity.class);
                ...
                viewHolder.CommentPostButton.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent commentPostIntent=new Intent(GocmenActivity.this,GocmenYorumActivity.class);
...
//post sayfasında gözükmeyi sağlar
    ...
    public static class GocmenViewHolder extends RecyclerView.ViewHolder {
        View mView;
        Button CommentPostButton;


        public GocmenViewHolder(@NonNull View itemView) {
            super(itemView);
            mView = itemView;
