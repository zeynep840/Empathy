...
public class Post2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent geriIntent = new Intent(Post2Activity.this, Main3Activity.class);
                ...
                postsRef1.child(current_user_id2 + postRandom2).updateChildren(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            startActivity(new Intent(Post2Activity.this, Main3Activity.class));
                            finish();
                        }
                        else{
                            Toast.makeText(Post2Activity.this,"Eror",Toast.LENGTH_SHORT).show();
                        }
