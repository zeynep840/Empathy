...
public class Post3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent geriIntent=new Intent(Post3Activity.this,Main4Activity.class);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                postsRef3.child(current_user_id3 + postRandom3).updateChildren(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                   ...
                   if(task.isSuccessful()){
                       startActivity(new Intent(Post3Activity.this, Main4Activity.class));
                       finish();
                   }
                   else{
                       Toast.makeText(Post3Activity.this,"Eror",Toast.LENGTH_SHORT).show();
