...
public class KadinHaklariPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kadin_haklari_post);
        ...
        backButton2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent geriIntent = new Intent(KadinHaklariPostActivity.this, KadinHaklariActivity.class);
                ...
                postsRef1.child(current_user_id2 + postRandom2).updateChildren(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            startActivity(new Intent(KadinHaklariPostActivity.this, KadinHaklariActivity.class));
                            finish();
                        }
                        else{
                            Toast.makeText(KadinHaklariPostActivity.this,"Eror",Toast.LENGTH_SHORT).show();
                        }
