...
public class ClickPostHayvanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_click_post_hayvan);
        ...
        ClickPostRef2=FirebaseDatabase.getInstance().getReference().child("Hayvan").child(PostKey4);
    ...
    private void EditCurrentPost2(String description3) {
        AlertDialog.Builder builder=new AlertDialog.Builder(ClickPostHayvanActivity.this);
        builder.setTitle("DÜZENLE");
        final EditText InputField=new EditText(ClickPostHayvanActivity.this);
        ...
        builder.setPositiveButton("Güncelle", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(ClickPostHayvanActivity.this,"Post başarıyla güncellendi",Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void SendUserToMainActivity2() {
        Intent mainIntent = new Intent(ClickPostHayvanActivity.this,HayvanActivity.class);
